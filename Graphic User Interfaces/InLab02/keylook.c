/*-------------------------------------------------------
   KEYLOOK.C -- Displays Keyboard and Character Messages
                (c) Charles Petzold
   Used as a basis from our textbook for a short piece of
   an in-lab exercise.    
  -------------------------------------------------------*/
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance,
     ...
     hwnd = CreateWindow (szAppName, "Keyboard Message Looker-In-Lab Startup Code",
                          WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
     ...
     switch (iMsg)
          ...
          case WM_KEYDOWN :
			   ...
			   {
				   MessageBox(hwnd, "F12 to Exit", "9 Pressed", MB_OK);
			   }
               return 0 ;
